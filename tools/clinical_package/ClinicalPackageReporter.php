...
class ClinicalPackageReporter
{
	...
	private static function ordered(array $report)
	{
		$order = array(
			...
			'new_entity_count','exact_match_entity_count','conflict_entity_count','dml_executed','package_data_imported','runtime_enabled','error_1','error_1_context','error_count','exit_code','validation_result',
		);
		$result = array();
