...
$invalid = $policy->warga(array('nik' => '123', 'nomor_kk' => '', 'nomor_bpjs_kis' => 'abc'));
identity_expect($invalid['valid'] === false && count($invalid['field_errors']) === 3, 'invalid_warga_fields_explicit');
