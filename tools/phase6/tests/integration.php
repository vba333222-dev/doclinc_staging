...
try {
	...
	$ddl = array(
		...
		"CREATE TABLE visit_dispositions(disposition_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,request_id INT(11) NOT NULL,version_no INT UNSIGNED NOT NULL,decision ENUM('visit','non_visit') NOT NULL,superseded_at DATETIME(6) NULL,PRIMARY KEY(disposition_id),KEY idx_visit_disposition_request(request_id,disposition_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
