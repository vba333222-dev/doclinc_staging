...
$db->schemas = array(
	'users' => array('userId', 'nama', 'email', 'role', 'status', 'must_change_password', 'no_hp', 'alamat', 'tgl', 'gender', 'foto', 'remark'),
	'puskesmas_staff' => array('staff_id', 'kode_pkm', 'nama', 'no_hp', 'profesi', 'nomor_sip', 'user_id', 'status'),
...
$db->rows = array(
	...
	'puskesmas_staff' => array(
		(object) array('staff_id' => 11, 'kode_pkm' => 'PKM01', 'nama' => 'Nakes Satu', 'no_hp' => '081234567890', 'profesi' => 'Dokter', 'nomor_sip' => 'SIP-001', 'user_id' => 201, 'status' => 'aktif'),
	),
	'm_puskesmas' => array(
