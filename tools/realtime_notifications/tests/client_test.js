...
(async () => {
	...
	expect(storage.getItem('doclinc.notification.sound.enabled') === '1', 'legacy_disabled_preference_is_normalized_to_sound_on');
	runtime.applySnapshot(snapshot([5, 4]), { reason: 'invalidation' });
	expect(audioElements[0].playCalls === 5, 'sound_remains_active_without_page_toggle');
