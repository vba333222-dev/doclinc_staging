...
class Clinical_review_m
{
    ...
    public function getByIdempotencyKeyForUpdate($key) { return $this->db->query('SELECT * FROM clinical_reviews WHERE idempotency_key = ? LIMIT 1 FOR UPDATE', array((string) $key))->row(); }
