...
function care_operations_assert_base(mysqli $db)
{
	...
	$required_columns = array(
		...
		array('request_staff_assignments', 'assignment_id', care_operations_column('int(11)', 'NO', null, 'auto_increment')),
		array('request_staff_assignments', 'request_id', care_operations_column('int(11)', 'NO', null)),
		array('request_staff_assignments', 'staff_id', care_operations_column('int(11)', 'NO', null)),
		array('request_staff_assignments', 'status', care_operations_column('varchar(20)', 'NO', null)),
