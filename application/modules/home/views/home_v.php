...
<body class="bg-light dl-dashboard-body">
									...
									<div class="card-body">
										...
										<?php if ($request_status === 'Accepted') : ?>
											<div class="mt-3">
												...
												<button type="button" class="btn btn-outline-primary btn-sm rounded-pill ms-1 doclinc-call-start" data-request-id="<?= html_escape((int) $id_request); ?>" data-call-mode="video">
													<i class="fas fa-video me-1"></i> Panggilan Video
												</button>
												<button type="button" class="btn btn-outline-primary btn-sm rounded-pill ms-1 doclinc-call-start" data-request-id="<?= html_escape((int) $id_request); ?>" data-call-mode="audio">
													<i class="fas fa-phone-alt me-1"></i> Panggilan Suara
												</button>
	...
	<script>
		(function(window, $) {
			const tokenUrl = <?= json_encode(base_url('home/livekit_token')); ?>;
			const sdk = function() {
