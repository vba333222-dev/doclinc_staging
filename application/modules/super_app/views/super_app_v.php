...
<body class="bg-success">
    <div class="position-relative">
        <div class="d-flex align-items-center justify-content-center vh-100">
            <center>
                <img class="wow animate__bounceIn" src="<?= base_url();?>assets/images/robinsar-fajar.png" alt="" height="120px">
                <h3 class="mb-0 text-white animate__animated animate__fadeIn">CILEGON BERSATU</h3>
            </center>
        </div>
