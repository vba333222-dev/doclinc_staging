...
$chat_back_url = !empty($legacy_superapp_url) ? rtrim($legacy_superapp_url, '/') . '/sehat_geh' : base_url('home');
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class="chat-container">
		...
		<div class="profile-header">
			...
			<img src="<?= base_url(); ?>assets/images/dokter_jaenul.jpeg" alt="Dokter" id="ustadzProfileImage">
			<div>
	...
	<script>
		...
		const dokter = 'pahlawan1';

		const currentUser = document.getElementById('username').value;
		const chatWith = dokter;
