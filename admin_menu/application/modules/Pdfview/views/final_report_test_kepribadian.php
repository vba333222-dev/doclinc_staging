...
<?php	
    ...
    foreach ($data_report->result_array() as $x){ 
        ...
        if($x['jenis_kelamin']=='Laki-laki'){
            $jeniskelamin='L';
        }else if($x['jenis_kelamin']=='Perempuan'){
            $jeniskelamin='P';
        }else{
...
<html lang="en">
    ...
    <body>
        ...
        <div class="z-index-top">
            ...
            <table style="width:100%;" border="1">
                <tr>
                    <td><h5>GAMBARAN KEPRIBADIAN</h5></td>
                </tr>
                <tr>
                    <td><?php echo $keterangan_klinis; ?></td>
                </tr>
                <tr>
                    <td><h5>GAMBARAN KONDISI PSIKOLOGIS</h5></td>
                </tr>
                <tr>
                    <td><?php echo $kondisi_psikologis; ?></td>
                </tr>
                <tr>
                    <td><h5>REKOMENDASI</h5></td>
                </tr>
                <tr>
